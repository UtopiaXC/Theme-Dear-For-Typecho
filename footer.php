...
<footer>
    ...
    <span class="intro">&copy; <?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"
            ...
            href="https://github.com/UtopiaXC/Theme-Dear-For-Typecho" target="_blank" title="Dear">Dear</a> By <a href="https://yayu.net/" target="_blank"
            title="Jeff Chen">Jeff Chen</a> and <a href="https://www.utopiaxc.cn/" target="_blank"
